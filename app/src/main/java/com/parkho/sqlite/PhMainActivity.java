...
public class PhMainActivity extends AppCompatActivity {
    ...
    private void insertData(int a_grade, int a_number, String a_strName, int a_age) {
        ...
        values.put(StudentEntry.AGE, a_age);
    ...
    private List getAllData() {
        ...
        while (cursor.moveToNext()) {
            ...
            int age = cursor.getInt(cursor.getColumnIndexOrThrow(StudentEntry.AGE));
            entityList.add(new PhStudentEntity(id, grade, number, strName, age));
        }
        cursor.close();
